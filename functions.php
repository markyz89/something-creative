...
if ( ! function_exists( 'starter_setup' ) ) :
	...
	function starter_setup() {
		...
		add_image_size( 'my-custom-image-size', 500, 200, true );
...
function starter_widgets_init() {
	register_sidebar( array(
		...
		// two new sidebars I registered. Note - sidebars do not have to be at the side.

	register_sidebar(array(
		'name' => 'Search box',
		'id' => 'search-sidebar',
		'description'   => 'Search box in the header', // desc
	    'before_widget' => '<div id="search-box" class="search-box">',  // markup that appears before each widget
	    'after_widget'  => '</div>', // 
	    'before_title'  => '<p>', // widget title markup
	    'after_title'   => '</p>',

	) );

		register_sidebar(array(
		'name' => 'Recent comments sidebars',
		'id' => 'rec-comments',
		'description'   => 'Recent comments sidebar', // desc
	    'before_widget' => '<div id="search-box" class="search-box">',  // markup that appears before each widget
	    'after_widget'  => '</div>', // 
	    'before_title'  => '<p>', // widget title markup
	    'after_title'   => '</p>',
...
function starter_scripts() {
	...
	wp_enqueue_style( 'bootstrap-4', get_template_directory_uri() . '/lib/bootstrap/css/bootstrap.min.css' );

	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/lib/bootstrap/js/bootstrap.min.js', array('jquery'), '4.0.1', true );
